...
namespace ParticleEmitter
{
    public class ParticleSystemSettings
    {
        ...
        private bool m_ermitterOn;                          // to activate and deactivate
        private Color m_color;                              //Color to draw
        ...
        public bool emitterOn
        {
            get { return m_ermitterOn; }
            set { m_ermitterOn = value; }
        }
