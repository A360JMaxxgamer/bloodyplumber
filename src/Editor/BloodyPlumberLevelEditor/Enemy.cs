...
namespace BloodyPlumberLevelEditor
{
    public class Enemy : Object
    {
        ...
        public void Initialize(float f_xStartPosition, float f_yStartPosition, float f_xStartVelocity, float f_yStartVelocity, float speed, short health, Animation startAnimation, int screenWidth,int id)
        {
